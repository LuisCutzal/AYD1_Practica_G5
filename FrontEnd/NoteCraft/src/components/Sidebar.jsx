  ...
  return (
    <>
      <div className="w-64 p-6">
        ...
        <ul>
          <li className={`mb-10 flex flex-1 gap-4 ${!isLoggedIn ? 'opacity-50 cursor-not-allowed' : ''}`}>
          ...
          <li className={`mb-10 flex flex-1 gap-4 ${!isLoggedIn ? 'opacity-50 cursor-not-allowed' : ''}`}>
            ...
            <a href="#" className="text-gray-700 hover:text-blue-500"
              onClick={isLoggedIn ? onShowArchivedNotes : (e) => e.preventDefault()}>
              Archivados
            </a>
          </li>
        </ul>
...
Sidebar.propTypes = {
  ...
  onShowArchivedNotes: propTypes.func.isRequired
};
